    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
          <p>Forever was born out of a passion for innovation and a desire to revolutionize the way people shop online. Our journey began with a simple idea: to provide a platform where customers can easly discover, explore, and purchase a wide range of products from the comfort of their homes.</p>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        ...
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          ...
          <p className='text-gray-600'>
            Our team of dedicated professionals is here to assist you the way, ensuring yout satisfaction is our top priority.
          </p>
        </div>
